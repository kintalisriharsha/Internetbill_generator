              ...
              <fieldset className="border border-gray-300 p-4 rounded-md mb-6">
                ...
                <div>
                  ...
                  <TextField
                    ...
                    name="billingDate"
                    size='small'
                    value={formData.billingDate ? formData.billingDate.format('DD-MM-YYYY') : ''}
                    InputProps={{
                      endAdornment: (
              ...
              <fieldset className='border border-gray-300 p-4 rounded-md mb-6'>
                ...
                <label htmlFor="speed" className='mb-3 block text-sm font-medium text-gray-800'>Tariff Plan Speed</label>
                 <CreatableSelect 
                    ...
                    isSearchable 
                    options={planOptions} 
                    value={planOptions.find((option) => option.value === formData.speed)}
                ...
                <CreatableSelect 
                    ...
                    value={packageOptions.find((option) => option.value === formData.package)}
                    onChange={handleSelectChange}
                    classNamePrefix="select"
                    />
                    <br />
                    ...
                    value={tariffOptions.find((option) => option.value === formData.plan)}
                    onChange={handleSelectChange}
                    classNamePrefix="select"
                    />
                    <br />    
              ...
              <fieldset className='border border-gray-300 p-4 rounded-md mb-6'>
                ...
                <label htmlFor="currency" className='mb-3 block text-sm font-medium text-gray-800'>Currency </label>
                 <CreatableSelect 
                    ...
                    value={currencyDetails.find((option) => option.value === formData.currency)}
                    onChange={handleSelectChange}
                    classNamePrefix="select"
                    />
                    <br />
                <label htmlFor="paymentMethod" className='mb-3 block text-sm font-medium text-gray-800'>Payment method</label>
                 <CreatableSelect 
                    ...
                    value={paymentDetails.find((option) => option.value === formData.paymentMethod)}
                    onChange={handleSelectChange}
                    classNamePrefix="select"
                    />
                    <br />
  ...
  {/* Add overflow container for small screens */}
              ...
              <table className="min-w-full table-fixed divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr>
                    <td className="px-4 py-2 whitespace-nowrap">{previewData.taxableAmount.toFixed(2)}</td>
                    <td className="px-4 py-2 whitespace-nowrap">9%</td>
                    <td className="px-4 py-2 whitespace-nowrap">{previewData.cgstAmount.toFixed(2)}</td>
                    <td className="px-4 py-2 whitespace-nowrap">9%</td>
                    <td className="px-4 py-2 whitespace-nowrap">{previewData.sgstAmount.toFixed(2)}</td>
                    <td className="px-4 py-2 whitespace-nowrap">{previewData.totalPayment.toFixed(2)}</td>
                  </tr>
                </tbody>
              </table>
              <table className='mt-8 -mb-3 border-b-2 border-gray-200 w-full text-xs'>
	             <tbody className='bg-gray-50'>
                  <tr>
                    <td className="px-4 py-2 whitespace-nowrap text-sm"><h1>Service Plan Summary</h1></td><td className='text-xs'><p>Account No: {formData.billNumber}</p></td><td><p>UserName :{formData.customerName}</p></td>
                  </tr>
                </tbody>  
              </table>
              ...
              <thead className="bg-gray-50">
                <tr>
                <th className="w-1/5 px-3 py-1 text-left text-xs font-medium text-gray-500 uppercase">Plan Speed</th>
                <th className="w-1/5 px-3 py-1 text-left text-xs font-medium text-gray-500 uppercase">Plan Package</th>
                <th className="w-1/5 px-3 py-1 text-left text-xs font-medium text-gray-500 uppercase">Plan Validity</th>
                <th className="w-1/5 px-3 py-1 text-left text-xs font-medium text-gray-500 uppercase">Discount</th>
                <th className="w-1/5 px-3 py-1 text-left text-xs font-medium text-gray-500 uppercase">Plan Amount</th>
                </tr>
                </thead>
                <tbody>
                  <tr>
                  <td className="px-4 py-2 whitespace-nowrap"><p>{formData.speed}</p></td>
                    <td className="px-4 py-2 whitespace-nowrap"><p>{formData.package}</p></td>
                    <td className="px-4 py-2 whitespace-nowrap"><p>{formData.plan}</p></td>
                    <td className="px-4 py-2 whitespace-nowrap">0</td>
                    <td className="px-4 py-2 whitespace-nowrap"><p>{formData.amount}</p></td>
                  </tr>
                </tbody>
              </table>
              <table className='mt-8 -mb-3 border-b-2 border-gray-200 w-full text-xs'>
	             <tbody className='bg-gray-50'>
                  <tr>
                    <td className="px-4 py-2 whitespace-nowrap text-sm"><h1>Reciept Details</h1></td><td><p>Account No: {formData.billNumber}</p></td><td><p>UserName :{formData.customerName}</p></td>
                  </tr>
                </tbody>  
              </table>
              <table className='mt-3 min-w-full table-fixed divide-y divide-gray-200'>
              <thead className="bg-gray-50">
                <tr>
                <th className="w-1/5 px-3 py-1 text-left text-xs font-medium text-gray-500 uppercase">Invoice No:</th>
                <th className="w-1/5 px-3 py-1 text-left text-xs font-medium text-gray-500 uppercase">Internet Service Description</th>
                <th className="w-1/5 px-3 py-1 text-left text-xs font-medium text-gray-500 uppercase">Amount Incl. Tax</th>
                </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="px-4 py-2 whitespace-nowrap"><p>{formData.invoiceNumber}</p></td>
                    <td className="px-4 py-2 whitespace-nowrap"><p>{formData.description}</p></td>
                    <td className="px-4 py-2 whitespace-nowrap"><p>{formData.amount}</p></td>
                  </tr>
                </tbody>
              </table>
              <p className='text-left p-4 text-sm text-gray-500 '>Registered office address : {formData.address}</p>
              <div className='border-2 mt-3 rounded-lg'>
                ...
                <ol className='pr-8 pl-8 pb-6'>
                    ...
                    <li>5. This Invoice is system generated hence signature and stamp are not required.</li>
                </ol>
              </div>
              <table className='mt-10 min-w-full table-fixed divide-y divide-gray-200'>
              <thead className="bg-gray-50">
                <tr>
                <th className="w-full text-center px-3 py-1 text-xs font-medium text-gray-500 uppercase" colSpan={3}>Acknowledgment Slip</th>
                </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="px-4 py-2 whitespace-nowrap"><p>Account No: {formData.billNumber}</p></td><td><p>Name :{formData.customerName}</p></td>
                  </tr>
                  <tr>
                  <td className="px-4 py-2 whitespace-nowrap"><p>Method :{formData.paymentMethod}</p></td><td><p>Invoice Number: {formData.invoiceNumber}</p></td>
                  </tr>
                </tbody>
              </table>
            </div>
